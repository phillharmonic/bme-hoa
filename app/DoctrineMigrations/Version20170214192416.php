 ...
 */
class Version20170214192416 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_complaint (user_id INT NOT NULL, complaint_id INT NOT NULL, INDEX IDX_5FC7BF51A76ED395 (user_id), INDEX IDX_5FC7BF51EDAE188E (complaint_id), PRIMARY KEY(user_id, complaint_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
